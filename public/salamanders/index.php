...
$salamanders = [
  ['id' => '1', 'salamanderName' => 'Red-Legged Salamander'], ['id' => '2', 'salamanderName' => 'Pigeon Mountain Salamander'],
  ['id' => '3', 'salamanderName' => 'ZigZag Salamander'], ['id' => '4', 'salamanderName' => 'Slimy Salamander']
];
...
------------------------------------------------------------------ */
require_once(SHARED_PATH . '../../private/shared/salamander-header.php');
?>
...
<table>
  <tr>
    ...
    <th>&nbsp;</th>
      ...
      ------------------------------------------------------------------>
          <td><?php echo $salamanders['id']; ?></td>
    	    <td><?php echo $salamanders['salamanderName']; ?></td>
